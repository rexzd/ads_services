  ...
  implements Comparable<Message>
{
  ...
  //----------------------------------------------------------
  //----------------------------------------------------------
  // NOTE: backend may update timestamp, not included in equals comparison
  public static boolean deepEquals (Message lhs, Message rhs)
  {
    if (!lhs.id.equals(rhs.id))
      return false;
//    if (!lhs.timestamp.equals(rhs.timestamp))
//      return false;
    if (!lhs.username.equals(rhs.username))
      return false;
    if (!lhs.topic.equals(rhs.topic))
      return false;
    if (!lhs.content.equals(rhs.content))
      return false;
